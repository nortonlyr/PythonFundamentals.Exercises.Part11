...
class CollegeStudentTest(unittest.TestCase):

    def test_instantiation(self):
        bob = gradebook.CollegeStudent("Bob", "Smith", "01201970")
        self.assertTrue(isinstance(bob, gradebook.Student))

    def test_is_subclass(self):
        self.assertTrue(issubclass(gradebook.CollegeStudent, gradebook.Student))
